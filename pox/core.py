...
class POXCore (EventMixin):
    ...
    def quit (self):
        ...
        """
        import threading
        if (self.starting_up or threading.current_thread() is self.scheduler._thread):
    ...
    def call_when_ready (self, callback, components=[], name=None, args=(), kw={}):
        """
    ...
    def listen_to_dependencies (self, sink, components=None, attrs=True, short_attrs=False, listen_args={}):
        """
