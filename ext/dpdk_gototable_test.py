...
class Test(EventMixin):
    ...
    def _handle_ConnectionUp (self, event):
        ...
        match_list=[]
        match_list.append(core.PofManager.get_field("Eth_Type")[0])
        table_idd=core.PofManager.add_flow_table(event.dpid, 'FirstEntryTable', of.OF_MM_TABLE, 128, match_list)
	...
	action_list=[]
        ...
        flow_entry_idd=core.PofManager.add_flow_entry(event.dpid,table_idd,matchx_list,ofinstructions,1,1)
        ...
        ofinstruction=core.PofManager.new_ins_goto_table(event.dpid,table_idd)
        ofinstructions.append(ofinstruction)
